	 ...
	 */
		...
		//Your default constructor goes here
		 ...
		 /**
			...
			//the sale price
		 public Product(String name1, double cost1, double unitPrice1, double discount1, int quantitySold1) {
			 name = name1;
			 cost = cost1;
			 unitPrice = unitPrice1;
			 discount = discount1;
			 quantitySold=quantitySold1;
			 unitSalePrice = calculateSalePrice(unitPrice, discount);
		 }
		 /**
			 * Constructor to initialize all the fields and calculate the sale price
		...
		//the sale price
		 ...
		 public Product(String name1, double cost1, double unitPrice1, int quantitySold1) {
			 name = name1;
			 cost = cost1;
			 unitPrice = unitPrice1;
			 discount = 0;
		...
		*/
		//Your method to calculate sale price goes here
		 private double calculateSalePrice(double unitPrice, double discount) {
			 return (((100-discount)/100)*unitPrice);
		 }
		/* Modifier methods */
		/**
		...
		//Your method to set the sale price before discount goes here
		 public void setPrice(double unitPrice1) {
			 unitPrice = unitPrice1;
			 unitSalePrice = calculateSalePrice(unitPrice, discount);
		 }
		/**
		...
		public void setQuantitySold(int quantitySold1) {
			quantitySold = quantitySold1;
		}
		/**
		...
		public void setCompany(String CompanyName1) {
